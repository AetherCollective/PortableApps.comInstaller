...
Section Main
	...
	;Download3 files
	${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download3URL" ""
	${If} $1 != ""
		StrCpy $2 $1 7
		StrCpy $3 $1 8
		...
		${OrIf} $3 == "https://"
			...
			${WriteConfig} Download3URL "$1"

			${TransferInstallerINIToConfig} DownloadFiles Download3KnockURL      -
			${TransferInstallerINIToConfig} DownloadFiles Download3Name          required
			${TransferInstallerINIToConfig} DownloadFiles Download3Filename      required
			${TransferInstallerINIToConfig} DownloadFiles Download3MD5           -
			${TransferInstallerINIToConfig} DownloadFiles Download3To            -
			${TransferInstallerINIToConfig} DownloadFiles Download3CachedByPAc   -

			${For} $R1 1 10
				${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download3AdvancedExtract$R1To" ""
				${If} $1 != ""
					${If} $1 == "<ROOT>"
						StrCpy $1 ""
					${EndIf}
					${WriteConfig} Download3AdvancedExtract$R1To "$1"
				${EndIf}
			${Next}

			${For} $R1 1 10
				${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download3AdvancedExtract$R1Filter" ""
				${If} $1 != ""
					${WriteConfig} Download3AdvancedExtract$R1Filter "$1"
				${EndIf}
			${Next}

			${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download3DoubleExtractFilename" ""
			${If} $1 != ""
				${WriteConfig} Download3DoubleExtractFilename "$1"

				${For} $R1 1 10
					${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download3DoubleExtract$R1To" ""
					${If} $1 != ""
						${If} $1 == "<ROOT>"
							StrCpy $1 ""
						${EndIf}
						${WriteConfig} Download3DoubleExtract$R1To "$1"
					${EndIf}
				${Next}

				${For} $R1 1 10
					${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download3DoubleExtract$R1Filter" ""
					${If} $1 != ""
						${WriteConfig} Download3DoubleExtract$R1Filter "$1"
					${EndIf}
				${Next}

			${EndIf}
		${Else}
			${WriteErrorToLog} "Installer.ini - DownloadFiles - Download3URL must begin with http://"
		${EndIf}
	${EndIf}
	
	;Download4 files
	${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download4URL" ""
	${If} $1 != ""
		StrCpy $2 $1 7
		StrCpy $3 $1 8
		...
		${OrIf} $3 == "https://"
			...
			${WriteConfig} Download4URL "$1"

			${TransferInstallerINIToConfig} DownloadFiles Download4KnockURL      -
			${TransferInstallerINIToConfig} DownloadFiles Download4Name          required
			${TransferInstallerINIToConfig} DownloadFiles Download4Filename      required
			${TransferInstallerINIToConfig} DownloadFiles Download4MD5           -
			${TransferInstallerINIToConfig} DownloadFiles Download4To            -
			${TransferInstallerINIToConfig} DownloadFiles Download4CachedByPAc   -

			${For} $R1 1 10
				${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download4AdvancedExtract$R1To" ""
				${If} $1 != ""
					${If} $1 == "<ROOT>"
						StrCpy $1 ""
					${EndIf}
					${WriteConfig} Download4AdvancedExtract$R1To "$1"
				${EndIf}
			${Next}

			${For} $R1 1 10
				${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download4AdvancedExtract$R1Filter" ""
				${If} $1 != ""
					${WriteConfig} Download4AdvancedExtract$R1Filter "$1"
				${EndIf}
			${Next}

			${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download4DoubleExtractFilename" ""
			${If} $1 != ""
				${WriteConfig} Download4DoubleExtractFilename "$1"

				${For} $R1 1 10
					${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download4DoubleExtract$R1To" ""
					${If} $1 != ""
						${If} $1 == "<ROOT>"
							StrCpy $1 ""
						${EndIf}
						${WriteConfig} Download4DoubleExtract$R1To "$1"
					${EndIf}
				${Next}

				${For} $R1 1 10
					${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download4DoubleExtract$R1Filter" ""
					${If} $1 != ""
						${WriteConfig} Download4DoubleExtract$R1Filter "$1"
					${EndIf}
				${Next}

			${EndIf}
		${Else}
			${WriteErrorToLog} "Installer.ini - DownloadFiles - Download4URL must begin with http://"
		${EndIf}
	${EndIf}
	
	;Download5 files
	${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download5URL" ""
	${If} $1 != ""
		StrCpy $2 $1 7
		StrCpy $3 $1 8
		...
		${OrIf} $3 == "https://"
			...
			${WriteConfig} Download5URL "$1"

			${TransferInstallerINIToConfig} DownloadFiles Download5KnockURL      -
			${TransferInstallerINIToConfig} DownloadFiles Download5Name          required
			${TransferInstallerINIToConfig} DownloadFiles Download5Filename      required
			${TransferInstallerINIToConfig} DownloadFiles Download5MD5           -
			${TransferInstallerINIToConfig} DownloadFiles Download5To            -
			${TransferInstallerINIToConfig} DownloadFiles Download5CachedByPAc   -

			${For} $R1 1 10
				${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download5AdvancedExtract$R1To" ""
				${If} $1 != ""
					${If} $1 == "<ROOT>"
						StrCpy $1 ""
					${EndIf}
					${WriteConfig} Download5AdvancedExtract$R1To "$1"
				${EndIf}
			${Next}

			${For} $R1 1 10
				${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download5AdvancedExtract$R1Filter" ""
				${If} $1 != ""
					${WriteConfig} Download5AdvancedExtract$R1Filter "$1"
				${EndIf}
			${Next}

			${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download5DoubleExtractFilename" ""
			${If} $1 != ""
				${WriteConfig} Download5DoubleExtractFilename "$1"

				${For} $R1 1 10
					${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download5DoubleExtract$R1To" ""
					${If} $1 != ""
						${If} $1 == "<ROOT>"
							StrCpy $1 ""
						${EndIf}
						${WriteConfig} Download5DoubleExtract$R1To "$1"
					${EndIf}
				${Next}

				${For} $R1 1 10
					${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download5DoubleExtract$R1Filter" ""
					${If} $1 != ""
						${WriteConfig} Download5DoubleExtract$R1Filter "$1"
					${EndIf}
				${Next}

			${EndIf}
		${Else}
			${WriteErrorToLog} "Installer.ini - DownloadFiles - Download5URL must begin with http://"
		${EndIf}
	${EndIf}
	
	;Download6 files
	${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download6URL" ""
	${If} $1 != ""
		StrCpy $2 $1 7
		StrCpy $3 $1 8
		...
		${OrIf} $3 == "https://"
			...
			${WriteConfig} Download6URL "$1"

			${TransferInstallerINIToConfig} DownloadFiles Download6KnockURL      -
			${TransferInstallerINIToConfig} DownloadFiles Download6Name          required
			${TransferInstallerINIToConfig} DownloadFiles Download6Filename      required
			${TransferInstallerINIToConfig} DownloadFiles Download6MD5           -
			${TransferInstallerINIToConfig} DownloadFiles Download6To            -
			${TransferInstallerINIToConfig} DownloadFiles Download6CachedByPAc   -

			${For} $R1 1 10
				${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download6AdvancedExtract$R1To" ""
				${If} $1 != ""
					${If} $1 == "<ROOT>"
						StrCpy $1 ""
					${EndIf}
					${WriteConfig} Download6AdvancedExtract$R1To "$1"
				${EndIf}
			${Next}

			${For} $R1 1 10
				${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download6AdvancedExtract$R1Filter" ""
				${If} $1 != ""
					${WriteConfig} Download6AdvancedExtract$R1Filter "$1"
				${EndIf}
			${Next}

			${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download6DoubleExtractFilename" ""
			${If} $1 != ""
				${WriteConfig} Download6DoubleExtractFilename "$1"

				${For} $R1 1 10
					${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download6DoubleExtract$R1To" ""
					${If} $1 != ""
						${If} $1 == "<ROOT>"
							StrCpy $1 ""
						${EndIf}
						${WriteConfig} Download6DoubleExtract$R1To "$1"
					${EndIf}
				${Next}

				${For} $R1 1 10
					${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download6DoubleExtract$R1Filter" ""
					${If} $1 != ""
						${WriteConfig} Download6DoubleExtract$R1Filter "$1"
					${EndIf}
				${Next}

			${EndIf}
		${Else}
			${WriteErrorToLog} "Installer.ini - DownloadFiles - Download6URL must begin with http://"
		${EndIf}
	${EndIf}
	
	;Download7 files
	${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download7URL" ""
	${If} $1 != ""
		StrCpy $2 $1 7
		StrCpy $3 $1 8
		...
		${OrIf} $3 == "https://"
			...
			${WriteConfig} Download7URL "$1"

			${TransferInstallerINIToConfig} DownloadFiles Download7KnockURL      -
			${TransferInstallerINIToConfig} DownloadFiles Download7Name          required
			${TransferInstallerINIToConfig} DownloadFiles Download7Filename      required
			${TransferInstallerINIToConfig} DownloadFiles Download7MD5           -
			${TransferInstallerINIToConfig} DownloadFiles Download7To            -
			${TransferInstallerINIToConfig} DownloadFiles Download7CachedByPAc   -

			${For} $R1 1 10
				${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download7AdvancedExtract$R1To" ""
				${If} $1 != ""
					${If} $1 == "<ROOT>"
						StrCpy $1 ""
					${EndIf}
					${WriteConfig} Download7AdvancedExtract$R1To "$1"
				${EndIf}
			${Next}

			${For} $R1 1 10
				${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download7AdvancedExtract$R1Filter" ""
				${If} $1 != ""
					${WriteConfig} Download7AdvancedExtract$R1Filter "$1"
				${EndIf}
			${Next}

			${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download7DoubleExtractFilename" ""
			${If} $1 != ""
				${WriteConfig} Download7DoubleExtractFilename "$1"

				${For} $R1 1 10
					${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download7DoubleExtract$R1To" ""
					${If} $1 != ""
						${If} $1 == "<ROOT>"
							StrCpy $1 ""
						${EndIf}
						${WriteConfig} Download7DoubleExtract$R1To "$1"
					${EndIf}
				${Next}

				${For} $R1 1 10
					${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download7DoubleExtract$R1Filter" ""
					${If} $1 != ""
						${WriteConfig} Download7DoubleExtract$R1Filter "$1"
					${EndIf}
				${Next}

			${EndIf}
		${Else}
			${WriteErrorToLog} "Installer.ini - DownloadFiles - Download7URL must begin with http://"
		${EndIf}
	${EndIf}
	
	;Download8 files
	${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download8URL" ""
	${If} $1 != ""
		StrCpy $2 $1 7
		StrCpy $3 $1 8
		...
		${OrIf} $3 == "https://"
			...
			${WriteConfig} Download8URL "$1"

			${TransferInstallerINIToConfig} DownloadFiles Download8KnockURL      -
			${TransferInstallerINIToConfig} DownloadFiles Download8Name          required
			${TransferInstallerINIToConfig} DownloadFiles Download8Filename      required
			${TransferInstallerINIToConfig} DownloadFiles Download8MD5           -
			${TransferInstallerINIToConfig} DownloadFiles Download8To            -
			${TransferInstallerINIToConfig} DownloadFiles Download8CachedByPAc   -

			${For} $R1 1 10
				${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download8AdvancedExtract$R1To" ""
				${If} $1 != ""
					${If} $1 == "<ROOT>"
						StrCpy $1 ""
					${EndIf}
					${WriteConfig} Download8AdvancedExtract$R1To "$1"
				${EndIf}
			${Next}

			${For} $R1 1 10
				${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download8AdvancedExtract$R1Filter" ""
				${If} $1 != ""
					${WriteConfig} Download8AdvancedExtract$R1Filter "$1"
				${EndIf}
			${Next}

			${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download8DoubleExtractFilename" ""
			${If} $1 != ""
				${WriteConfig} Download8DoubleExtractFilename "$1"

				${For} $R1 1 10
					${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download8DoubleExtract$R1To" ""
					${If} $1 != ""
						${If} $1 == "<ROOT>"
							StrCpy $1 ""
						${EndIf}
						${WriteConfig} Download8DoubleExtract$R1To "$1"
					${EndIf}
				${Next}

				${For} $R1 1 10
					${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download8DoubleExtract$R1Filter" ""
					${If} $1 != ""
						${WriteConfig} Download8DoubleExtract$R1Filter "$1"
					${EndIf}
				${Next}

			${EndIf}
		${Else}
			${WriteErrorToLog} "Installer.ini - DownloadFiles - Download8URL must begin with http://"
		${EndIf}
	${EndIf}
	
	;Download9 files
	${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download9URL" ""
	${If} $1 != ""
		StrCpy $2 $1 7
		StrCpy $3 $1 8
		...
		${OrIf} $3 == "https://"
			...
			${WriteConfig} Download9URL "$1"

			${TransferInstallerINIToConfig} DownloadFiles Download9KnockURL      -
			${TransferInstallerINIToConfig} DownloadFiles Download9Name          required
			${TransferInstallerINIToConfig} DownloadFiles Download9Filename      required
			${TransferInstallerINIToConfig} DownloadFiles Download9MD5           -
			${TransferInstallerINIToConfig} DownloadFiles Download9To            -
			${TransferInstallerINIToConfig} DownloadFiles Download9CachedByPAc   -

			${For} $R1 1 10
				${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download9AdvancedExtract$R1To" ""
				${If} $1 != ""
					${If} $1 == "<ROOT>"
						StrCpy $1 ""
					${EndIf}
					${WriteConfig} Download9AdvancedExtract$R1To "$1"
				${EndIf}
			${Next}

			${For} $R1 1 10
				${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download9AdvancedExtract$R1Filter" ""
				${If} $1 != ""
					${WriteConfig} Download9AdvancedExtract$R1Filter "$1"
				${EndIf}
			${Next}

			${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download9DoubleExtractFilename" ""
			${If} $1 != ""
				${WriteConfig} Download9DoubleExtractFilename "$1"

				${For} $R1 1 10
					${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download9DoubleExtract$R1To" ""
					${If} $1 != ""
						${If} $1 == "<ROOT>"
							StrCpy $1 ""
						${EndIf}
						${WriteConfig} Download9DoubleExtract$R1To "$1"
					${EndIf}
				${Next}

				${For} $R1 1 10
					${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download9DoubleExtract$R1Filter" ""
					${If} $1 != ""
						${WriteConfig} Download9DoubleExtract$R1Filter "$1"
					${EndIf}
				${Next}

			${EndIf}
		${Else}
			${WriteErrorToLog} "Installer.ini - DownloadFiles - Download9URL must begin with http://"
		${EndIf}
	${EndIf}
	
	;Download10 files
	${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download10URL" ""
	${If} $1 != ""
		StrCpy $2 $1 7
		StrCpy $3 $1 8
		...
		${OrIf} $3 == "https://"
			...
			${WriteConfig} Download10URL "$1"

			${TransferInstallerINIToConfig} DownloadFiles Download10KnockURL      -
			${TransferInstallerINIToConfig} DownloadFiles Download10Name          required
			${TransferInstallerINIToConfig} DownloadFiles Download10Filename      required
			${TransferInstallerINIToConfig} DownloadFiles Download10MD5           -
			${TransferInstallerINIToConfig} DownloadFiles Download10To            -
			${TransferInstallerINIToConfig} DownloadFiles Download10CachedByPAc   -

			${For} $R1 1 10
				${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download10AdvancedExtract$R1To" ""
				${If} $1 != ""
					${If} $1 == "<ROOT>"
						StrCpy $1 ""
					${EndIf}
					${WriteConfig} Download10AdvancedExtract$R1To "$1"
				${EndIf}
			${Next}

			${For} $R1 1 10
				${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download10AdvancedExtract$R1Filter" ""
				${If} $1 != ""
					${WriteConfig} Download10AdvancedExtract$R1Filter "$1"
				${EndIf}
			${Next}

			${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download10DoubleExtractFilename" ""
			${If} $1 != ""
				${WriteConfig} Download10DoubleExtractFilename "$1"

				${For} $R1 1 10
					${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download10DoubleExtract$R1To" ""
					${If} $1 != ""
						${If} $1 == "<ROOT>"
							StrCpy $1 ""
						${EndIf}
						${WriteConfig} Download10DoubleExtract$R1To "$1"
					${EndIf}
				${Next}

				${For} $R1 1 10
					${ReadINIStrWithDefault} $1 $strInstallerINIFile "DownloadFiles" "Download10DoubleExtract$R1Filter" ""
					${If} $1 != ""
						${WriteConfig} Download10DoubleExtract$R1Filter "$1"
					${EndIf}
				${Next}

			${EndIf}
		${Else}
			${WriteErrorToLog} "Installer.ini - DownloadFiles - Download10URL must begin with http://"
		${EndIf}
	${EndIf}
